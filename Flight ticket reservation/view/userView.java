...
public class userView {
	...
	{
		System.out.println("--->WELCOME TO SERA AIRLINES-->");
	...
	}catch(Exception e) {System.out.println("jdvkcnsdjkcvcn");};
	}
	private static void cheakPNRStatus() {
	...
	private static void bookTicket()
	{
		...
		UserController.addToRequest(newPasssanger);
		System.out.println();
	    }
	    UserController.decreaseCapacity(flightNumber,ticket);
	    System.out.println("THANK YOU FOR CHOOSING SERA AIRLINES");
	    App.clickOption();
		}
	    else {
